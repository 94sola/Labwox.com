...
const Ore = () => {
  const compounds = [
    "Ce", "Dy", "Eu", "Er", "Ho", "Gd", "La", "Lu", "Nd", "Pr", "Sm", "Sc", "Th", "Tb", "Tm", "U", "Yb", "Y",
    "Ca", "Ir", "Pd", "Pt", "Rh", "Ru", "Au", "Te", "Al", "As", "Ba", "Be", "Ga", "Li", "In", "Mg", "K", "Rb",
    "Se", "Na", "Sr", "Bi", "Sb", "B", "Ge", "Hf", "Mo", "Nb", "P", "Re", "Si", "S", "Ta", "Sn", "Ti", "W", "Zr",
    "Cd", "Cr", "Co", "Cu", "Fe", "Pb", "Mn", "Hg", "Ni", "Ag", "Tl", "V", "Zn"
  ];
  ...
  return (
    <Wrapper hideHeader>
      ...
      >
        ...
        {/* Available Compounds - Scrollable Box */}
        <div className="mt-10 max-w-4xl mx-auto px-4">
          <h3 className="text-4xl font-thin text-[#153D63] mb-6 text-center">
            Available Elements
          </h3>
          <div className="border border-gray-300 bg-white rounded-2xl p-6 text-center shadow-md hover:shadow-lg transition max-h-60 overflow-y-auto scrollbar-thin scrollbar-thumb-[#153D63]/60 scrollbar-track-gray-100">
            ...
            {samplingDetails.map((sample, i) => (
              ...
              >
                <img
                  ...
                  className="w-48 h-32 mx-auto transition-transform duration-300 hover:scale-110 hover:rotate-3 rounded-lg"
                />
                <button
                ...
                >
                  <ul className="text-gray-700 text-sm md:text-base space-y-2 px-4">
