...
const samples = [
  {
    ...
    description:
      "Testing of fresh fruits and vegetables for single residue 'Other' pesticides to ensure consumer safety and compliance.",
  ...
  },
  {
    ...
    description:
      "Residue analysis in wheat, rice, corn, and barley for 'Other' pesticides supporting food safety and trade compliance.",
  ...
  },
  {
    ...
    description:
      "Testing of livestock and poultry feed to detect single residues of 'Other' pesticides and prevent contamination.",
  ...
  },
  {
    ...
    description:
      "Analysis of raw milk, cheese, and dairy products for residues of 'Other' pesticides to ensure international compliance.",
  ...
  },
  {
    ...
    description:
      "Targeted screening of spices such as turmeric, coriander, and basil for residues of 'Other' pesticide compounds.",
  ...
  },
  {
    ...
    description:
      "Monitoring packaged and processed foods like snacks and baked goods for contamination from 'Other' pesticide residues.",
  ...
  },
  {
    ...
    description:
      "Analysis of water, juices, and bottled drinks for trace levels of single residue 'Other' pesticides.",
  ...
  },
  {
    ...
    description:
      "Testing of soil and environmental samples for persistence and accumulation of 'Other' pesticides.",
...
const Other = () => {
  ...
  // ✅ Updated list of single residue "Others" compounds
  const compounds = [
    "Butachlor",
    "Atrazine",
    "Alachlor",
    ...
    <Wrapper>
      ...
      >
        ...
        <div className="max-w-5xl mx-auto px-4 mb-8">
          <Link
            to="/pollutantanaly"
            className="inline-flex items-center gap-2 text-[#153D63] hover:text-[#FFC000] transition-colors font-medium"
          >
        ...
        <div className="max-w-4xl mx-auto text-center mb-12 px-4">
          <h1 className="text-5xl md:text-7xl font-light text-[#153D63] mb-6">
            Single Residue – Others
          </h1>
          <p className="text-gray-700 mb-8 max-w-2xl mx-auto">
            The “Others” category includes herbicides and selective compounds 
            that are analyzed individually. These tests support food safety, 
