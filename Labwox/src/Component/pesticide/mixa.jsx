...
const samples = [
  {
    ...
    description:
      "Screening of fresh fruits and vegetables for residues of Mix A pesticides to ensure consumer safety and meet export regulations.",
  ...
  },
  {
    ...
    description:
      "Comprehensive testing of wheat, rice, corn, and barley for Mix A pesticide residues, supporting food safety and trade compliance.",
  ...
  },
  {
    ...
    description:
      "Analysis of livestock and poultry feed to prevent Mix A pesticide residues from entering the animal-derived food chain.",
  ...
  },
  {
    ...
    description:
      "Testing of raw milk, cheese, butter, and yogurt for Mix A pesticide residues to ensure international compliance.",
  ...
  },
  {
    ...
    description:
      "Targeted analysis of herbs and spices such as basil, coriander, and turmeric for pesticide contamination risks from Mix A compounds.",
  ...
  },
  {
    ...
    description:
      "Monitoring of packaged and processed foods including snacks, baked goods, and ready-to-eat meals for Mix A residues.",
  ...
  },
  {
    ...
    description:
      "Analysis of surface water, groundwater, juices, and bottled beverages for trace levels of Mix A pesticides.",
  ...
  },
  {
    ...
    description:
      "Testing of agricultural soil and environmental matrices to evaluate Mix A pesticide accumulation and persistence.",
      ...
      <section className="bg-gradient-to-b from-white via-neutral-50 to-white py-16 lg:py-24 mb-10">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12 px-4">
          ...
          <p className="text-gray-700 mb-8 text-center max-w-2xl mx-auto">
            Mix A consists of selected herbicides commonly screened for food and 
            environmental safety. Designed for multi-residue analysis, it ensures 
