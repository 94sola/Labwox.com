...
const Pyrethroids = () => {
  ...
  return (
    <Wrapper hideHeader>
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center my-12 px-4">
          ...
          <p className="text-base md:text-lg text-gray-700 leading-relaxed max-w-4xl mx-auto">
            Pyrethroids are synthetic chemical insecticides modeled after natural pyrethrins.
            These tests support food safety, environmental monitoring, and regulatory compliance
            by detecting residues in diverse matrices.
          </p>
        </div>
      ...
      <section ref={sampleRef} className="py-12 lg:py-20">
