...
const samples = [
  {
    ...
    description:
      "Screening of fresh fruits and vegetables for residues of Mix C pesticides to ensure consumer safety and meet export regulations.",
  ...
  },
  {
    ...
    description:
      "Comprehensive testing of wheat, rice, corn, and barley for Mix C pesticide residues, supporting food safety and trade compliance.",
  ...
  },
  {
    ...
    description:
      "Analysis of livestock and poultry feed to prevent Mix C pesticide residues from entering the animal-derived food chain.",
  ...
  },
  {
    ...
    description:
      "Testing of raw milk, cheese, butter, and yogurt for Mix C pesticide residues to ensure international compliance.",
  ...
  },
  {
    ...
    description:
      "Targeted analysis of herbs and spices such as basil, coriander, and turmeric for pesticide contamination risks from Mix C compounds.",
  ...
  },
  {
    ...
    description:
      "Monitoring of packaged and processed foods including snacks, baked goods, and ready-to-eat meals for Mix C residues.",
  ...
  },
  {
    ...
    description:
      "Analysis of surface water, groundwater, juices, and bottled beverages for trace levels of Mix C pesticides.",
  ...
  },
  {
    ...
    description:
      "Testing of agricultural soil and environmental matrices to evaluate Mix C pesticide accumulation and persistence.",
