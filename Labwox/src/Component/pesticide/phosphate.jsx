...
const samples = [
  {
    ...
    description:
      "Testing of fresh fruits and vegetables for single-residue organophosphates to ensure consumer safety and compliance.",
  ...
  },
  {
    ...
    description:
      "Residue analysis in wheat, rice, corn, and barley for organophosphate pesticides supporting food safety and trade compliance.",
  ...
  },
  {
    ...
    description:
      "Testing of livestock and poultry feed to detect single residues of organophosphate pesticides and prevent contamination.",
  ...
  },
  {
    ...
    description:
      "Analysis of raw milk, cheese, and dairy products for residues of organophosphate pesticides to ensure international compliance.",
  ...
  },
  {
    ...
    description:
      "Targeted screening of spices such as turmeric, coriander, and basil for residues of organophosphate pesticide compounds.",
  ...
  },
  {
    ...
    description:
      "Monitoring packaged and processed foods like snacks and baked goods for contamination from organophosphate residues.",
  ...
  },
  {
    ...
    description:
      "Analysis of water, juices, and bottled drinks for trace levels of single-residue organophosphates.",
  ...
  },
  {
    ...
    description:
      "Testing of soil and environmental samples for persistence and accumulation of organophosphate pesticides.",
...
const Organophosphate = () => {
  ...
  // ✅ Organophosphate compounds list
  const compounds = [
    "Chlorpyrifos",
    "Dichlorvos (DDVP)",
    "Profenofos",
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center mb-12 px-4">
          <h1 className="text-5xl md:text-7xl font-light text-[#153D63] mb-6">
            Single Residue – Organophosphates
          </h1>
