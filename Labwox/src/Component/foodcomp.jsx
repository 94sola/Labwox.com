...
const applications = [
  { name: "Fatty Acid Methyl Esters (FAMEs)", link: "/metal" },
  { name: "Minerals in Food", link: "/mineral" },
  { name: "Others", link: "/Ores" },
];
      ...
      <section className="relative w-full py-16 mb-10 lg:py-24 bg-gradient-to-b from-black via-neutral-900 to-black overflow-hidden">
        ...
        <div className="relative text-center mb-12 px-4">
          ...
          <p className="mt-4 text-lg text-gray-50 max-w-5xl mx-auto leading-relaxed">
            ...
            food and related products. FromFatty Acid Methyl Esters (FAMEs)
            to Minerals and other  components,
            our techniques ensure accurate, reliable, and reproducible results 
            for research, industry, and regulatory applications.
          </p>
        </div>
