...
import classroom from "../assets/image/classrooom.png";
import tools from "../assets/image/tools.png";
import train from "../assets/image/generation.png";
  ...
  return (
    <Wrapper>
      <section className="relative bg-white px-6 py-20 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-72 h-72 bg-purple-200 rounded-full blur-3xl opacity-20 -z-10"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-pink-200 rounded-full blur-3xl opacity-20 -z-10"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
            ...
            {features.slice(0, 2).map((f, i) => (
              <motion.div
                ...
                className="relative rounded-3xl p-[2px] shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 min-h-[460px]"
              >
                {/* Gradient Border */}
                <div
                ...
                >
                  <div className="flex justify-center mb-6">
                    <motion.img
                      src={f.img}
                      alt={f.title}
                      className="w-60 h-60 object-contain drop-shadow-md hover:scale-105 transition-transform duration-300"
              ...
              >
                <div className="flex justify-center mb-6">
                  <motion.img
                    ...
                    className="w-56 h-56 object-contain drop-shadow-md hover:scale-105 transition-transform duration-300"
                    whileHover={{ scale: 1.08 }}
                  />
                </div>
