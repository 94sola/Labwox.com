...
const Labwox = () => {
  return (
    <Wrapper>
      {/* Desktop Layout */}
      <div className="relative bg-white px-8 py-20 lg:py-36 lg:rounded-t-[40px] shadow-xl flex flex-col justify-center overflow-hidden">

        {/* Decorative SVGs */}
        <div className="absolute top-10 left-10 opacity-60 z-0 animate-spinSlow hidden lg:block">
        ...
        <div className="w-full mt-20 bg-neutral-100 py-2 overflow-hidden">
          <motion.div
            className="flex gap-16 whitespace-nowrap text-[#153D63] text-2xl font-thin px-4"
            animate={{ x: ['100%', '-100%'] }}
        ...
        {/* Floating Heavy Metals (Bottom) */}
        <HeavyMetalLabel symbol="Pb" label="Lead" className="bottom-[8%] left-[25%]" color="text-red-500" delay={1.2} />
        <HeavyMetalLabel symbol="Hg" label="Mercury" className="bottom-[3%] right-[5%]" color="text-yellow-400" delay={1.4} />
        <HeavyMetalLabel symbol="Cd" label="Cadmium" className="bottom-[6%] left-[51%]" color="text-pink-500" delay={1.6} />
      ...
      <div className="block lg:hidden bg-white px-4 py-12 space-y-12">
        ...
        <div className="w-full bg-neutral-100 py-3 overflow-hidden">
          <motion.div
            className="flex gap-8 whitespace-nowrap text-[#153D63] text-xl font-thin px-4"
            animate={{ x: ['100%', '-100%'] }}
