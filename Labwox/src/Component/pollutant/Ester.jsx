          ...
          >
            ...
            <div className="max-w-5xl mx-auto text-center mb-12 px-4">
              ...
              <p className="text-xl text-gray-700 leading-relaxed">
                <strong>Phthalate esters</strong> are synthetic plasticizers widely used in
                consumer and industrial products. At Chemxpert, we offer accredited services
                to detect and measure phthalates in environmental, food, biological, and
                product samples.
              </p>
