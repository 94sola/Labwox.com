                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                  {compounds.map((compound, index) => (
                    <motion.div
                      ...
                      className="border border-gray-300 bg-white rounded-xl p-4 text-center text-gray-800 text-sm md:text-base font-medium shadow-sm hover:shadow-md hover:border-[#FFC000] transition-all duration-300"
                    >
                      {compound}
                    </motion.div>
                  ))}
