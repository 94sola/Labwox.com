  ...
  const overviewData = [
    {
      ...
      content: (
        <>
          ...
          <span className="text-basm font-medium">Crude oil & refined petroleum products:</span> gasoline, diesel, kerosene, lubricating oils.<br />
          <span className="text-sm font-medium">Industrial effluents & sludges:</span> coking plants, petroleum refineries, creosote waste.<br />
    ...
    <Wrapper hideHeader>
      ...
      <section ref={contentRef} className="bg-gradient-to-b from-white via-neutral-50 to-white py-12 lg:py-20">
        ...
        <div className="max-w-4xl mx-auto text-center my-12 px-4">
          <h1 className="text-5xl md:text-6xl font-thin text-[#153D63] mb-6">PAH Mix F</h1>
