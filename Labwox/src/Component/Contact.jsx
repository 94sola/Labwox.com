...
const Contact = () => {
  ...
  return (
    <Wrapper>
      <section className="py-20 px-6 md:px-20 mb-10 bg-[#f0f0f8]">
        <div className="mx-auto space-y-10">
          <div className="text-center space-y-4">
            <h1 className="font-sans text-5xl/[60px] font-semibold text-[#153D63]">
              Reach Out to Us!
            </h1>
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white border border-[#153D63] rounded-[10px] text-sm text-[#153D63] focus:outline-none focus:ring-2 focus:ring-[#0e1f3d]"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows="6"
                className="w-full px-4 py-3 bg-white border border-[#153D63] rounded-[10px] text-sm text-[#64748b] focus:outline-none focus:ring-2 focus:ring-[#0e1f3d] resize-none"
                required
              />
            </div>
            ...
            <button
              ...
              className={`w-full inline-flex items-center justify-center gap-2 text-sm font-bold py-4 rounded-[10px] transition-colors ${
                isLoading
                  ? "bg-[#FFC000] text-[#153D63] hover:bg-[#cf9c03]"
                  : "bg-[#FFC000] text-[#153D63] cursor-not-allowed"
              }`}
            >
