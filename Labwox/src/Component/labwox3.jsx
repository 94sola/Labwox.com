...
const Labwox = () => {
  return (
    <Wrapper>
      {/* Blue Testimonial Banner */}
      <div className="relative bg-neutral-300 overflow-hidden py-12 px-4 sm:px-8 lg:px-20">
        <img
          src={lab}
        ...
        <div className="relative bg-[#153D63] rounded-3xl shadow-xl p-6 sm:p-10 lg:p-16 z-10">
        ...
        <div className="mt-16 sm:mt-20 px-2 sm:px-4 md:px-8 lg:px-12">
