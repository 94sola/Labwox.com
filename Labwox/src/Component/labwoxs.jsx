  ...
  return (
    <Wrapper>
      <section className="relative py-28 bg-white overflow-hidden">
        <div className="relative max-w-8xl mx-auto px-10 lg:px-18">
          <div className="grid md:grid-cols-2 gap-4 items-start">
            ...
            <h2 className="text-5xl md:text-6xl font-bold leading-[1.1] tracking-tight text-left">
              ...
              {" "}
              <span className="text-gray-900">idea to impact</span>

              <br />

              <span
                className="bg-gradient-to-r from-[#5a8bff] to-[#1d4ed8] bg-clip-text text-transparent"
              >
                faster
              </span>
              {" "}
              <span className="text-gray-900">with Chemxpert</span>
            </h2>
            <div className="flex flex-col gap-6 text-left animate-fadeInSlow">
              <p className="text-lg md:text-xl text-gray-800 leading-relaxed">
                Chemxpert is Labwox’s institutional partnership program that
                empowers universities with free pilot testing, advanced
                analytical support, and access to world-class instrumentation —
                without the financial burden of owning or maintaining
                high-cost laboratory equipment.
              </p>
