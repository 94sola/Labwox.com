        ...
        <div className="relative max-w-7xl mx-auto px-10 lg:px-18">
          <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            <h2 className="text-5xl md:text-6xl font-bold leading-[1.1] tracking-tight text-left">
              <span
                className="bg-gradient-to-r from-yellow-200 via-yellow-100 to-yellow-200 bg-clip-text text-transparent"
              >
              Go from idea
              </span>
              {" "}
              <span className="text-gray-50"> to impact with  
              </span>
              {" "}
              <span className="bg-gradient-to-r from-yellow-200 via-yellow-100 to-yellow-200 bg-clip-text text-transparent">Chemxpert</span>
            </h2>
            <div className="flex flex-col gap-6 text-left animate-fadeInSlow">
              ...
              <Link to="/chemxpert">
                <button
                  className="group relative inline-flex items-center gap-3 text-lg font-medium text-yellow-300 hover:text-yellow-500 transition-all duration-300"
                >
                  <span className="relative z-10">Discover chemxpert</span>
                  <span className="relative w-5 h-5 flex items-center justify-center">
                    <span className="absolute text-yellow-400 group-hover:opacity-0 transition-opacity duration-300">
                      →
                    </span>
