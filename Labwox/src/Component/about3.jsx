...
const About = () => {
  ...
  return (
    <Wrapper>
      <section className="relative bg-gradient-to-b from-white via-neutral-100 to-white py-20 text-[#153D63] overflow-hidden">
        <div className="max-w-8xl mx-auto px-10 sm:px-14 lg:px-18 text-center">
          <motion.h2
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="text-4xl md:text-5xl lg:text-6xl max-w-5xl mx-auto font-semibold mb-16 leading-snug"
          >
